...
final kTranslationsMap = <Map<String, Map<String, String>>>[
  ...
  // add_image
  {
    ...
    'dqchwjl7': {
      ...
      'es': 'Ingrese los detalles aquí...',
      'fr': 'Entrez les détails ici...',
      'hi': 'यहां विवरण दर्ज करें...',
      'ja': 'ここに詳細を入力してください...',
      'ro': 'Introdu detalii aici...',
    },
    'zri0jsmt': {
      'en': 'Art',
      'es': 'Arte',
  ...
  // select_wallet
  {
    ...
    '0vbn1js5': {
      'en': 'from the list below',
      'es': 'de la lista a continuación',
      'fr': 'de la liste ci-dessous',
      'hi': 'नीचे दी गई सूची से',
      'ja': '以下のリストから',
      'ro': 'din lista de mai jos',
    },
    'y77dn71t': {
      'en': 'Avalanche',
      'es': 'avalancha',
